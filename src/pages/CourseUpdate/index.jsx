      ...
      <div className="container text-center">
        ...
        >
          ...
          <div className="label-form">
            اضف صوره* (Choose image (.jpg, .png, ...))
            <span className="text-danger">اختياري</span>
          </div>
          <input
            type="file"
            name="image"
          ...
          <button
            ...
            className="d-grid col-3 py-3 fs-4 fw-bold align-content-center mx-auto btn btn-danger mt-3"
          >
            cancel
          </button>
        </form>
